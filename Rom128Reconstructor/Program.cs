...
File.Copy("Spectrum128_ROM0.asm", "Recreated/128k_0_asm.asm");
File.WriteAllBytes("Recreated/128k_0_rom.bin", reconstructedRom0128.Binary);
File.WriteAllText("Recreated/128k_0_map.map", JsonConvert.SerializeObject(reconstructedRom0128.Map));

File.Copy("Spectrum128_ROM1.asm", "Recreated/128k_1_asm.asm");
File.WriteAllBytes("Recreated/128k_1_rom.bin", reconstructedRom1128.Binary);
File.WriteAllText("Recreated/128k_1_map.map", JsonConvert.SerializeObject(reconstructedRom1128.Map));

File.Copy("SpectrumPlus2_ROM0.asm", "Recreated/Plus2_0_asm.asm");
File.WriteAllBytes("Recreated/Plus2_0_rom.bin", reconstructedRom0plus2.Binary);
