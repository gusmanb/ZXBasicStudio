...
namespace ZXBasicStudio.DocumentEditors.ZXTextEditor.Classes.Breakpoints
{
                ...
                if (TextView.VisualLines.Count > 0)
                {
                    ...
                    foreach (var breakPoint in _breakpoints)
                    {
                        ...
                        if (visualLine != null)
                        {
                            ...
                            new Rect(offset,
                                 visualLine.GetTextLineVisualYPosition(visualLine.TextLines[0], VisualYPosition.TextTop) + offset - TextView.VerticalOffset,
